<%-- 
    ...
    Created on : 7/12/2019, 02:36:51 PM
    Author     : miran
--%>
                        ...
                        <div class="col-xl-9 col-lg-10 mx-auto">
                            <div class="bg-faded rounded p-5">
                                <h2 class="section-heading mb-4">
                                    <span class="section-heading-upper">¿No tienes cuenta?</span>
                                    <span class="section-heading-lower">Registrate aquí</span>
                                </h2>
...
<%
    ...
    int nivel = 2;
    usuarioDao.insertUsuario(new Usuario(id, nombre, direccion, email, usuario, contrasena, edad, nivel));
